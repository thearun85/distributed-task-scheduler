# Distributed Task Scheduler Plan

## Project Goal
Build a production grade Task scheduler that teaches distributed system concepts.

---

# Version 0.1 - A Single Node Task Scheduler
...
| 7 | Final Verifications | Yet to Start |
